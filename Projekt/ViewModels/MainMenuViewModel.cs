    ...
    public class MainMenuViewModel : ConditionalContentControlViewModel, IPageViewModel
    {
        ...
        private async Task<bool> CheckPageModelPermissions(string name)
        {
            ...
            return name switch
            {
                ...
                "SubjectEditViewModel" => await Authenticate(PermissionHelper.CanModifyData, PermissionHelper.CanEditOtherSchedules,
                PermissionHelper.CanEditOwnSchedule, PermissionHelper.CanEditOwnProfile),
