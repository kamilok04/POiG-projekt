...
namespace Projekt.ViewModels
{
    ...
    {
        string ITable.DefaultQuery => "SELECT dk.nazwa AS kierunek, w.nazwa AS wydział FROM kierunek k JOIN dane_kierunku dk ON k.id_kierunku = dk.id JOIN wydzial w ON k.id_wydzialu = w.id;";
